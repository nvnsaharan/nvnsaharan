...
(function () {
    ...
    function T(a, b) {
        ...
        function g(d) {
            ...
            if (p || v)
                p &&
                    (a.width = Math.max(
                        Math.min(a.width, L - a.x - a.right),
                        150
                    )),
                    v &&
                        (a.height = Math.max(
                            Math.min(a.height, M - a.y - a.bottom),
                            35
                        )),
                    a.resize();
            if (n || E)
                n &&
                    (a.x = Math.max(
                        Math.min(a.x, L - a.width - a.right),
                        a.left
                    )),
                    E &&
                        (a.y = Math.max(
                            Math.min(a.y, M - a.height - a.bottom),
                            a.top
                        )),
                    a.move();
            H = I;
    ...
    e.move = function (a, b, c) {
        "undefined" === typeof a
            ...
            : c ||
              ((this.x = a
                  ? (a = R(a, L - this.left - this.right, this.width))
                  : 0),
              (this.y = b
                  ? (b = R(b, M - this.top - this.bottom, this.height))
                  : 0));
